...
class SubCategory extends Template
{
    ...
    public function getCategoryCheck($id)
    {
        ...
        foreach($subCategories as $subCategory) {
            if ($this->getCategoryCheck($subCategory->getId())){
                return true;
            }
        }
    }
    ...
    {
        $CategoryConfig = $this->helperData->getSubCategoryConfig('');
        $categoryIds = $CategoryConfig['categories'];
        ...
        $CategoryConfig['categories'] = implode(",", $categoryIds);
