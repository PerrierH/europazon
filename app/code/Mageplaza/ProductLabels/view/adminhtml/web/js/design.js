        ...
        setTextColor: function (index, type) {
            ...
            switch (index){
                ...
                case 22 :
                    ...
                    textLabel.css({'color': '#EE2C2C'});
                    break;
                case 33 :
                    self.textColor('#C60000', type);
                    textLabel.css({'color': '#C60000'});
                    break;
                case 35 :
                    self.textColor('#FF0000', type);
                    textLabel.css({'color': '#FF0000'});
                    break;
                case 37 :
                    self.textColor('#E8152C', type);
                    textLabel.css({'color': '#E8152C'});
                    break;
                default:
                    self.textColor('#FFFFFF', type);
                    textLabel.css({'color': '#FFFFFF'});
                    break;
            }
        },
