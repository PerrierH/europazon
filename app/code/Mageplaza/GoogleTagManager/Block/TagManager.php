...
class TagManager extends Template
{
    ...
    public function getCategotyCollection($category)
    {
        ...
        if ($collection->getSize()==0){
            $collection = $this->_catalogLayer->getProductCollection()->getCollectionClone();
        }
    ...
    protected function _getProductCollection()
    {
        if ($this->productCollection === null) {
            ...
            if ($this->productCollection->getSize()==0){
                $this->productCollection = clone $this->_catalogLayer->getProductCollection()->getCollectionClone();
            }
        }
